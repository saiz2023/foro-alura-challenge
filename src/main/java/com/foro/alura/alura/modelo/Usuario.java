...
import com.foro.alura.alura.usuario.DatosRegistroUsuario;
...
public class Usuario implements UserDetails {
	...
	public Usuario(DatosRegistroUsuario datos, String pass) {
	...
	public void actualizarUsuario(DatosActualizarUsuario datos,String pass) {
		if(datos.nombre() != null)this.nombre = datos.nombre();
		if(datos.email() != null)this.email = datos.email();
		if(datos.pass()!= null)this.pass = pass;
	}
